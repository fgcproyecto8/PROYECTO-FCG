    ...
    <article className="flex flex-col overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-lg dark:border-slate-800 dark:bg-slate-900">
      ...
      <div className="space-y-3 p-4">
        ...
        <button
          ...
          className="inline-flex w-full items-center justify-center gap-2 rounded-xl border border-slate-300 bg-slate-50 py-2.5 text-sm font-semibold text-slate-700 transition hover:border-emerald-500 hover:text-emerald-500 dark:border-slate-700 dark:bg-slate-800/50 dark:text-slate-200 dark:hover:border-emerald-500 dark:hover:text-emerald-400"
        >
          <Eye size={16} />
          Ver detalles
        </button>
            ...
            className={`w-full rounded-xl border py-2.5 text-sm font-semibold transition ${
              isFull
                ...
                : isLastSpot
                  ...
                  : "border-emerald-500/60 bg-emerald-500 text-zinc-950 hover:bg-emerald-400"
            }`}
          >
            {isFull
              ? "Completo"
